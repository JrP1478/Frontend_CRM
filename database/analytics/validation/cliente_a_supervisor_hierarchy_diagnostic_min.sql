...
Diagnóstico MINIMO supervisor / gestor zonal CLIENTE_A
SOLO LECTURA
...
FROM #Advisors AS a
LEFT JOIN legacy_crm_reporteria.dbo.RPTC_253_PRODUCCIONGENERALPORGESTOR_DIA AS r
...
FROM #Advisors AS a
LEFT JOIN legacy_crm_reporteria.dbo.RPTC_253_PRODUCCIONGENERALPORGESTOR_ACUMULADO AS r
    ON r.NID_USUARIO = a.nId_Usuario
...
(
    ...
    FROM legacy_crm_reporteria.dbo.RPTC_253_PRODUCCIONGENERALPORGESTOR_DIA AS r

...
ETL CLIENTE_A: evolución histórica de cartera
...
CREATE OR ALTER PROCEDURE etl.usp_load_cliente_a_portfolio_evolution
    @crm_client_id   INT,
    ...
    BEGIN TRY
        ...
        */
        ...
        SELECT
            ...
            'CLIENTE_A_EVOLUTION_DAILY_OK' AS assessment
        FROM analytics.fact_portfolio_evolution_daily AS f

...
- calendario;
- carteras;
- snapshot diario de Portfolio CLIENTE_A;
...
Para CLIENTE_A Administrativo / Corporativo, campaña agosto 2026:
...
010_load_cliente_a_portfolio_snapshot.sql
```

Después:

```sql
EXEC etl.usp_load_cliente_a_portfolio_snapshot
    @crm_client_id = <ID CLIENTE CRM>,
    @client_code = 'CLIENTE_A',

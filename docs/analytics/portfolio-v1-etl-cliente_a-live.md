...
Incorporar la operación intradía de CLIENTE_A sin tocar todavía asesor/supervisor.
...
Para CLIENTE_A V1 el volumen de la vista ya materializada es pequeño, por lo que el
...
el snapshot real de esa fecha, `etl.usp_load_cliente_a_portfolio_snapshot` actualiza
...
etl/020_load_cliente_a_live_operations.sql
```
...
- fuente `CLIENTE_A CORPORATIVO`.

No incluye CLIENTE_A GOBIERNO.
...
`validation/cliente_a_live_etl_validation.sql`

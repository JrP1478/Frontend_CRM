...
IMPORTANTE:
- este script EJECUTA etl.usp_load_cliente_a_live_operations dos veces;
- ejecutar en legacy_crm_analytics;
- precondición: haber ejecutado previamente etl.usp_load_cliente_a_advisor_daily
...
DECLARE @source_client_name VARCHAR(150) = 'CLIENTE_A CORPORATIVO';
...
(
    ...
    FROM legacy_crm_reporteria.dbo.vw_bi_gerencia_gestiones_pagos AS g
    INNER JOIN analytics.dim_portfolio AS p
        ON p.client_key = @client_key

...
Esta versión restringe el análisis al MISMO universo CLIENTE_A validado:
- mes/campaña actual;
- hasta hoy;
...
PRINT '============================================================';
PRINT '1. ASESORES CLIENTE_A OPERATIVOS';
PRINT '============================================================';

IF OBJECT_ID('tempdb..#ClienteAAdvisors') IS NOT NULL
    DROP TABLE #ClienteAAdvisors;
...
WHERE t.cCli_Nombre COLLATE DATABASE_DEFAULT
      = 'CLIENTE_A CORPORATIVO' COLLATE DATABASE_DEFAULT
...
SELECT
    ...
    r.nId_Perfil,
    r.nId_PerfilGest
FROM #ClienteAAdvisors AS a
LEFT JOIN legacy_crm_reporteria.dbo.rpt_ref_usuario AS r
    ON r.nId_Usuario = a.nId_Usuario
ORDER BY a.nombre_asesor;


PRINT '============================================================';
PRINT '3. STAGING RPTC_253 ACOTADO A CLIENTE_A/CARTERAS/MES';
PRINT '============================================================';
...
INNER JOIN #ClienteAAdvisors AS a
...
PRINT '============================================================';
PRINT '8. COMPARACION CON DNI DISPONIBLES EN PROD CLIENTE_A';
PRINT '============================================================';
...
SELECT
    ...
    CASE
        ...
        (
            SELECT 1
            FROM legacy_crm_reporteria.dbo.PBI_CARTERA_DIA_CLIENTE_A_CORP_ADMINISTRATIVO_PROD AS p

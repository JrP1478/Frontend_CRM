...
export const suite = defineSuite('adicionalClienteBApi.validators', [
  test('acepta la respuesta documentada por GetOperativasClienteB', () => {
    assert.equal(isAdicionalClienteBApi(createValidResponse()), true);
  }),

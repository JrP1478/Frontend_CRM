...
export const suite = defineSuite('AdicionalClienteBSummary', [
  test('representa la respuesta CLIENTE_B en una lista semántica de dos columnas', () => {
    const html = renderToStaticMarkup(
      <AdicionalClienteBSummary data={data} />
    );

    assert.match(html, /adicional-cliente_b-list/);

...
Ejecutar conectado a legacy_crm_analytics con una cuenta autorizada a administrar
SQL Server Agent. El job revisa cada 5 minutos si legacy_crm_reporteria publico una
...
DECLARE
    @job_name SYSNAME = N'ANALYTICS_CLIENTE_A_INTRADAY',
    @schedule_name SYSNAME = N'ANALYTICS_CLIENTE_A_INTRADAY_CADA_5_MIN',
...
BEGIN
    EXEC msdb.dbo.sp_add_job
        @job_name = @job_name,
        @enabled = 1,
        @description = N'Refresco condicionado del Portfolio Control Center CLIENTE_A.',
...
BEGIN
    EXEC msdb.dbo.sp_update_jobstep
        ...
        @command = N'EXEC etl.usp_refresh_cliente_a_intraday @crm_client_id = 95;',
        @on_success_action = 1,
        @on_fail_action = 2;
END
ELSE

...
Diagnóstico de identidad estable del asesor CLIENTE_A
SOLO LECTURA.
...
- localizar posibles tablas maestras de usuario dentro de legacy_crm_reporteria.
...
PRINT '============================================================';
PRINT '1. STAGING OPERACIONAL CLIENTE_A';
PRINT '============================================================';
...
/*
Busca objetos de legacy_crm_reporteria que expongan columnas útiles para

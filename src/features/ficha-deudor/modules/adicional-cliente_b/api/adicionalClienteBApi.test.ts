...
import { fetchAdicionalClienteB } from './adicionalClienteBApi';
...
export const suite = defineSuite('adicionalClienteBApi', [
  test('consulta GetOperativasClienteB con los tres identificadores requeridos', async () => {
    ...
    try {
      const result = await fetchAdicionalClienteB({
        idDeudor: '3607007',
        idCartera: '34374',
        idCliente: '59',
      });
      ...
      assert.equal(
        ...
        '/v1/Boton/GetOperativasClienteB'
      );
      assert.equal(

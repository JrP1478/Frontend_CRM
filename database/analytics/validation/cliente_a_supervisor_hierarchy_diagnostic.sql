...
Diagnóstico de jerarquía Supervisor -> Asesor CLIENTE_A
SOLO LECTURA
...
PRINT '============================================================';
PRINT '1. ASESORES CLIENTE_A ACTUALES';
PRINT '============================================================';
...
FROM legacy_crm_reporteria.sys.objects AS o
INNER JOIN legacy_crm_reporteria.sys.schemas AS s
    ON s.schema_id = o.schema_id
INNER JOIN legacy_crm_reporteria.sys.columns AS c
    ON c.object_id = o.object_id
INNER JOIN legacy_crm_reporteria.sys.types AS ty
...
(
    ...
    FROM legacy_crm_reporteria.sys.columns AS c
    WHERE
        LOWER(c.name) LIKE '%supervisor%'
        OR LOWER(c.name) LIKE '%coordinador%'
        OR LOWER(c.name) LIKE '%jefe%'
...
INNER JOIN legacy_crm_reporteria.sys.objects AS o

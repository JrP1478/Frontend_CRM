...
ETL intradía CLIENTE_A desde GESTION-COB2
...
CREATE OR ALTER PROCEDURE etl.usp_load_cliente_a_live_operations
    @crm_client_id       INT,
...
BEGIN
    ...
    IF ISNULL(@source_rows, 0) = 0
        THROW 51305, 'GESTION-COB2 no devolvió filas para el scope CLIENTE_A solicitado.', 1;
    ...
    BEGIN TRY
        ...
        */
        ...
        /*
          ...
          GESTION-COB2 es la fuente autoritativa de estos campos para CLIENTE_A V1.
        */
        UPDATE f
        SET

...
Validación de meta mensual CLIENTE_A y curva esperada.

PRERREQUISITOS:
1. Ejecutar 011_portfolio_v1_cliente_a_target_support.sql.
2. Generar y ejecutar el SQL producido por:
   scripts/analytics/export_cliente_a_goals_snapshot_sql.py
...
DECLARE @source_code VARCHAR(50) = 'CLIENTE_A_BASE_GOALS';
...
FROM staging.cliente_a_goal_monthly
...
(
    ...
    THROW 52207, 'V1 no espera metas por cartera para esta carga CLIENTE_A.', 1;
